...
export function Welcome({navigation}) {
    return (
        <SafeAreaView style={{flex: 1}}>
            <View style={{flex: 1}}>
                <Image source={require('../../../assets/office.jpg')} resizeMode="cover" 
                style={{
                    width: '100%',
                    flex: 0.6
                }}
                 />
                <View style={{flex: 0.20, marginVertical:30, marginHorizontal:10}}>
                ...
                <View style={{flex: 0.20,flexDirection:'row', justifyContent:'space-between', marginVertical:30, marginHorizontal:30}}>
