        ...
        <View style={{flex:0.85, flexDirection:'column'}}>
            <View style={{flex:0.2, flexDirection:'column', marginHorizontal: 20, marginVertical: 40}}>
                <View style={{flexDirection:'row'}}>
                    ...
                    <View style={{marginHorizontal: 15}}>
                        <Text style={{fontSize: 17}}>Lex MaccHartey</Text>
                        <Text style={{fontSize: 16, color:"#7D7E8C"}}>Chief Tech Developer</Text>
                    </View>
                </View>
                 {/* Social media */}
            ...
            <View style={{flex: 0.6,flexDirection:'column',marginHorizontal: 20}}>
                ...
                <View style={styles.userDetails}>
                    ...
                    <Text style={styles.userText}>mail@hoodinMails.com</Text>
                </View>
                <View style={styles.userDetails}>
                    <EvilIcons name="location" size={24} color="ash" />
                    <Text style={styles.userText}>18th Main Street Holmes</Text>
                </View>
            </View>
         </View>
        {/* End of mainPage */}
